  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-24 px-6">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-blue-600 mb-6 text-center">Detalle de la sesión</h1>
        {ejercicios.length === 0 ? (
            ...
            {ejercicios.map((ej) => (
              <li key={ej.id} className="bg-white p-4 rounded shadow">
                ...
                {ej.series_detalle.map((s) => (
                  <div key={s.id} className="grid grid-cols-3 gap-2 my-1">
        ...
        <div className="text-center mt-6">
          <button onClick={eliminarSesion} className="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-700">
            Eliminar sesión
          </button>
        </div>
      </div>
